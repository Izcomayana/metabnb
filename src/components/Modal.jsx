...
import walletCollect from "../images/wallet-collect.png";
...
export default function Modal({ closeModal }) {
  ...
  return (
    <div onClick={handleClose} id="modal" className='fixed z-[2] inset-0 bg-black bg-opacity-25 backdrop-blur-sm transition duration-500 flex items-center justify-center'>
      <div>
        <div id="crypto-modal" tabIndex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed top-40 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
          <div className="relative p-4 w-full max-w-md h-full md:h-auto">
            <div className="relative bg-white rounded-lg shadow">
              <button onClick={closeModal} type="button" className="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="crypto-modal">
              ...
              <div className="p-6">
                <p className="text-sm font-normal text-black">Connect with one of our available wallet providers or create a new one.</p>
                <ul className="my-4 space-y-3">
                  <li>
                    <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 bg-[#F8F9FA] rounded-lg hover:bg-gray-100 group hover:shadow dark:hover:bg-gray-500 border">
                  ...
                  <li>
                    <a href="#" className="flex items-center p-3 text-base font-bold text-gray-900 bg-[#F8F9FA] rounded-lg hover:bg-gray-100 group hover:shadow dark:hover:bg-gray-500 border">
                      <img src={walletCollect} alt="" className='w-5' />
